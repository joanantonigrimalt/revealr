...
<head>
  ...
  <title>Your Lease Analysis Report — Revealr</title>
</head>
<body style="margin:0;padding:0;background:#faf9f7;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#1a1814;">
  <div style="max-width:640px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="margin-bottom:32px;">
      ...
      <div style="color:#6b6560;font-size:14px;">Lease Intelligence Platform</div>
    </div>

    <!-- Greeting -->
    <h1 style="font-size:26px;font-weight:700;color:#1a1814;margin:0 0 8px;">Your Lease Analysis Is Ready</h1>
    ...
    <div style="border-top:1px solid #e8e4df;padding-top:24px;color:#9c9590;font-size:12px;line-height:1.6;">
      <p style="margin:0 0 8px;">This analysis was generated by AI and is for informational purposes only. It does not constitute legal advice. Always consult a qualified attorney before signing any lease agreement.</p>
